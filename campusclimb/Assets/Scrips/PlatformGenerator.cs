...
public class PlatformGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Un-comment this for more complete code
        GameObject tempPlat = Instantiate(PlatA.getRandomConPlat(), new Vector3(0, ((float)yPos), 0), Quaternion.identity) as GameObject;
        this.gameObjectList.Add(tempPlat);
    ...
    private void generateBlocks()
    {
            ...
            if (gameObjectList.Count < 10)
            {
                GameObject tempInst = Instantiate(chooseNextBlock(), new Vector3(0, ((float)yPos), 0), Quaternion.identity) as GameObject;
                this.gameObjectList.Add(tempInst);
            ...
            {
                GameObject dest = gameObjectList[0];
